...
class Config:
    ...
    DEFAULT_SNIFFER_QUEUE_SIZE = 5000
    DEFAULT_SNIFFER_WORKERS = 2
    ...
    BPF_FILTER: str = os.getenv("IDS_BPF_FILTER", DEFAULT_BPF_FILTER)
    ...
    SNIFFER_QUEUE_SIZE: int = int(os.getenv("IDS_SNIFFER_QUEUE_SIZE", str(DEFAULT_SNIFFER_QUEUE_SIZE)))
    SNIFFER_WORKERS: int = int(os.getenv("IDS_SNIFFER_WORKERS", str(DEFAULT_SNIFFER_WORKERS)))
